#include <Stepper.h>
int echoPin1=17; // attach pin D2 Arduino to pin Echo of HC-SR04
int trigPin1=16; //attach pin D3 Arduino to pin Trig of HC-SR04
int echoPin2=15; // attach pin D2 Arduino to pin Echo of HC-SR04
int trigPin2=14; //attach pin D3 Arduino to pin Trig of HC-SR04
// defines variables
